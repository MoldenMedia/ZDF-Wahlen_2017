...
Dim theDateModified     As String = "12.04.2017 jn"
...
Sub readGeometryDetails( strTypeOfGraphics As String )
	...
	ElseIf strTypeOfGraphics = "UMHorizontalX" Then
		...
		' set strTypeOfBar for UMVPD=UMVP
		If sGraphicDetails.strTypeOfGraph = "UMHPD" Then
			sGraphicDetails.strTypeOfGraph = "UMHP"
		End If
		...
		If sGraphicDetails.strTypeOfGraph = "UMKB" Then
			sGraphicDetails.fGroupGap  = 12.0
			sGraphicDetails.fElemGap   = 7.0
		End If
