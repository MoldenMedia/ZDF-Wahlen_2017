...
'	contBlenderElementIN.FindSubcontainer( kEleRefPlane ).Position.Y = dblValue
	' hide reference line position, in case they are visible
	contBlenderElementIN.FindSubcontainer( kEleRefText ).Active = FALSE
	contBlenderElementIN.FindSubcontainer( kEleRefPlane ).Active = FALSE
