...
Dim kBarKoalSubPathBase      As String = "$BAR_KOAL$BAR_"
...
'println "[path] ..hiding..: [$" & contKBar.Name & kDataSubPath & kBarKoalSubPathBase & "1X" & "]...................."		
	...
	For iKBar = 1 To nKBar
		...
		contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPath & CStr(iKBar) ).FindKeyframeOfObject("k_value").FloatValue = dblValue
		contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPathMirror & CStr(iKBar) ).FindKeyframeOfObject("k_value").FloatValue = dblValue
'println "[path]: [" & kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPath & CStr(iKBar) & "]...................."		
		' set material
		tmpMaterial = contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPath & CStr(iKBar) ).CreateMaterial(kServerMaterialPath & aMaterial[iKBar-1] )
		contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPath & CStr(iKBar) ).Material = tmpMaterial
		tmpMaterial = contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPathMirror & CStr(iKBar) ).CreateMaterial(kServerMaterialPath & aMaterial[iKBar-1] )
		contKBar.FindSubContainer( kDataSubPath & kBarKoalSubPathBase & CStr(nKBar) & "X" & kBarColoredSubPathMirror & CStr(iKBar) ).Material = tmpMaterial
	Next
